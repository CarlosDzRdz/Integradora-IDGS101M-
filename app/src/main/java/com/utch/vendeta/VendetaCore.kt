...
val gameStages = listOf(
    GameStage(0, "Primer acertijo",    "Escanee el código QR al resolver el primer acertijo.",       "BIBLIOTECA_NIVEL_1"), //DOOR_1
    GameStage(1, "Segundo acertijo",      "Escanee el código QR al resolver el segundo acertijo.",      "CAFETERIA_NIVEL_2"), //CONSOLE_02
    GameStage(2, "Tercer acertijo",  "Escanee el código QR al resolver el tercer acertijo.",        "LABORATORIO_NIVEL_3"), //CAM_03
    GameStage(3, "Cuarto acertijo",  "Escanee el código QR al resolver el cuerto acertijo.",    "AUDITORIO_NIVEL_4"), //LAB_04
    GameStage(4, "Quinto acertijo", "Escanee el código QR al resolver el quinto acertijo.",      "CANCHAS_NIVEL_5") //EXIT_05
)
